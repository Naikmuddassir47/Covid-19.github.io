            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="moving_to_dead.php?id=<?php echo $res['id'];?>" onclick="return confirm('Are you sure, the patient is dead ?')" class="btn btn-danger btn-sm rounded-1" title="Dead"><i class="fa fa-ambulance text-white " aria-hidden="true"></i></a>
