...
$select = " SELECT * FROM patient_details WHERE L_del = '' AND is_dead = '' AND is_recovered = '' ";
            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="moving_to_recovered.php?id=<?php echo $res['id'];?>" onclick="return confirm('Are you sure, the patient is recovered ?')" class="btn btn-success btn-sm rounded-1" title="Recovered"><i class="fa fa-heartbeat text-white " aria-hidden="true"></i></a>
